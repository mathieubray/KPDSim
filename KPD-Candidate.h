...
std::string KPDCandidate::candidateString() {
	...
	candidateInfo << KPDFunctions::bloodTypeToString(candidateBT) << ",";			// Blood Type
	candidateInfo << candidatePRA << ",";									// PRA
	candidateInfo << candidateAge << ",";									// Age
	candidateInfo << KPDFunctions::boolToMaleFemale(candidateMale) << ",";	// Gender
	candidateInfo << KPDFunctions::raceToString(candidateRace) << ",";			// Race
	candidateInfo << KPDFunctions::boolToYesNo(candidateDiabetes) << ",";	// Diabetes
	...
	candidateInfo << KPDFunctions::boolToYesNo(candidatePrevTrans) << ",";	// Previous Transplants
	candidateInfo << candidateTOD << ",";									// Time on Dialysis
	candidateInfo << KPDFunctions::boolToYesNo(candidateHepC) << ",";		// Hep C Status
	candidateInfo << KPDFunctions::insuranceToString(candidateInsurance);			// Insurance
...
std::string KPDCandidate::candidateOutput(int space) {
	...
	candidateInfo << indent.str() << "PRA: " << candidatePRA <<  ", BT: " << KPDFunctions::bloodTypeToString(candidateBT) << std::endl;
	...
	candidateInfo << std::endl;
	candidateInfo << indent.str() << "Age: " << candidateAge << ", Sex: " << KPDFunctions::boolToMaleFemale(candidateMale) << ", Race: " << KPDFunctions::raceToString(candidateRace) << ", Diabetes: " << KPDFunctions::boolToYesNo(candidateDiabetes) << std::endl;
	...
	candidateInfo << indent.str() << "Previous Transplant: " << KPDFunctions::boolToYesNo(candidatePrevTrans) << ", Time on Dialysis: " << candidateTOD << std::endl;
	candidateInfo << indent.str() << "Hep C: " << KPDFunctions::boolToYesNo(candidateHepC) << ", Inusrance: " << KPDFunctions::insuranceToString(candidateInsurance) << std::endl;
